...
export const formSignUpAction = async ({request}) => {
    ...
    console.log(data) // obiectul unde se impacheteaza toate rsp
        ...
        let errors = {}
            ...
            if(!data.email ){
               return errors.email = "Email is required"
                ...
                return errors.email = "Email is too short!"
            }else if(!data.email.match(email_pattern)){
                return errors.email = "You need to enter a valid email address"
            }
    
            // if(!data.firstName || !data.lastName ){
            //     return errors.name = "Name is required"
            // }else if(!data.firstName.match(name_pattern) || !data.lastName.match(name_pattern)){
            //     return errors.name = "Please enter only alphabetical characters"
            // }
    
            // if(!data.password ){
            //     return errors.psswword = "Password is required"
            // }else if(data.password.length < 8){
            //     return errors.password =  "Password must be at least 8 characters"
            // } else if (!data.password.trim().match(password_pattern)){
            //     return errors.password = "Password must contain at least one capital letter, one lowercase letter, numbers and symbols"
            // }
